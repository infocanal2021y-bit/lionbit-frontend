...
export const Sidebar = () => {
  ...
  // 🔥 Cierra menú móvil cuando cambia la ruta
  useEffect(() => {
    setMobileOpen(false);
  }, [location.pathname]);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Private Digital Banking Platform
              </p>
            </div>
          </div>

          {/* ⚠️ Si sigue dando error, comenta esto */}
          <NotificationBell />
        </div>
      </div>
  ...
  return (
    <div>
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-950 border-r border-slate-800 transform transition-transform duration-300 lg:hidden ${
